...
<div class="content-wrapper mt-5 pt-3">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Add Bio For Resume</h2>
        ...
        <div class="card-body">
            <?php
            if (isset($_SESSION['error_bio_msg'])) { ?>

                <div class="alert alert-info alert-dismissible " role="alert">
                    <?php echo $_SESSION['error_bio_msg']; ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="bio_create_act.php" method="post" class="form-section " enctype="multipart/form-data" data-aos="fade-up" data-aos-duration="3000">
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="bio" id="description" class="form-control" rows="10" placeholder="Enter Description" required></textarea>
                        ...
                        <div class="float-right mb-3">
                            <input type="submit" name="submit" value="Add Bio" class="btn btn-dark">
                        </div>
