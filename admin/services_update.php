...
<div class="content-wrapper mt-5 pt-3">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Update Services</h2>
        ...
        <div class="card-body">
            ...
            <?php
            if (isset($_SESSION['update_serv_error'])) { ?>

            <div class="alert alert-info alert-dismissible " role="alert">
                <?php echo $_SESSION['update_serv_error']; ?>
            ...
            unset($_SESSION['update_serv_errror']);
            ?>
            ...
            <div class="row ">
                ...
                <div class="col-md-12">
                    <form class="form-section " method="post" action="services_update_act.php"
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="title" placeholder="Enter tagline"
                                    name="tagline" value="<?php echo $row['title'] ?>">
                            </div>
                        </div>
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="title" placeholder="Enter tile" name="title"
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="taglines" placeholder="Enter icon in html"
