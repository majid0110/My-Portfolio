...
<?php
$id = $_GET['id'];
$sql = "SELECT * FROM resume_education WHERE id=$id";
$query = mysqli_query($con, $sql);
$row = mysqli_fetch_assoc($query); ?>
<div class="content-wrapper mt-5 pt-3">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Update Education Info</h2>
        ...
        <div class="card-body">
            ...
            <?php
            if (isset($_SESSION['update_education_error'])) { ?>

                <div class="alert alert-info alert-dismissible " role="alert">
                    <?php echo $_SESSION['update_education_error']; ?>
            ...
            unset($_SESSION['update_education_errror']);
            ?>
            ...
            <div class="row ">
                ...
                <div class="col-md-12">
                    <form class="form-section " method="post" action="education_update_act.php" enctype="multipart/form-data" data-aos="fade-up" data-aos-duration="3000">
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="title" placeholder="Enter Email" name="degree_title" value="<?php echo $row['degree_title'] ?>">
                            </div>
                        </div>
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" class="form-control" id="date" name="degree_date" value="<?php echo $row['degree_date'] ?>">
                            </div>
                        </div>
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="taglines" placeholder="Enter institute" name="institute" value="<?php echo $row['institute'] ?>">
                            </div>
                        </div>
                        <div class="row  mb-3">
